...
// clean — data attribute based navigation
navigationLinks.forEach(link => {
  link.addEventListener("click", function () {
    const targetPage = this.textContent.trim().toLowerCase(); // safer
    ...
    navigationLinks.forEach(nav => {
      nav.classList.toggle("active", nav.textContent.trim().toLowerCase() === targetPage);
    });
